...
## 1.1 Data cleaning and data wrangling
...
## 1.2 Summarising statistica of our data

### 1.2.1 Look at mean median sum and Sd
...
### 1.2.2 Summarise the factors of our interest into a table
...
## 2.3 Is the increase of house price dependent of location (Rural vs Urban)?
